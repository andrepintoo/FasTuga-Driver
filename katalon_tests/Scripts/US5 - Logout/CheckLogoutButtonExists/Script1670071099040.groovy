...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - email'), 'contacto@email.pt', 
    0)
...
Mobile.verifyElementText(findTestObject('Object Repository/android.widget.CheckedTextView - Logout'), 'Logout')
