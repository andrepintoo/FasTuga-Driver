...
Mobile.verifyElementExist(findTestObject('Object Repository/android.widget.ScrollView - Assigned Orders List'), 0)
...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - Claim'), 0)

TestObject modifiedObj = new TestObject()
modifiedObj.addProperty("xpath", ConditionType.EQUALS, "//android.widget.ScrollView[1]/android.widget.GridLayout[1]/android.widget.Button[1]")

String values = Mobile.getAttribute(modifiedObj, 'text',
	0)

String [] valuesSplit = values.split(':')
String status = valuesSplit[5]
assert status.equals(' DELIVERING')
