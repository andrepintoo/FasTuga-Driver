...
public class GetOrderReadyNotificationTests {
	...
	public void the_status_is(String string) {
		...
		String values = Mobile.getAttribute(newObj, 'text',
				0)
	...
	@Given("the user waits {string} seconds")
	public void the_user_waits_seconds(String seconds) {
		Mobile.delay(Integer.parseInt(seconds))
	}
